class JogoDaVelha {
  ...
  checarStatus() {
    for (let i = 0; i < 3; i++) {
      if (
        this.quadro[i][0] !== "" &&
        this.quadro[i][0] === this.quadro[i][1] &&
        this.quadro[i][0] === this.quadro[i][2]
      ) {
    ...
    for (let i = 0; i < 3; i++) {
      if (
        this.quadro[0][i] !== "" &&
        this.quadro[0][i] === this.quadro[1][i] &&
        this.quadro[0][i] === this.quadro[2][i]
      ) {
    ...
    if (
      this.quadro[0][0] !== "" &&
      this.quadro[0][0] === this.quadro[1][1] &&
      this.quadro[0][0] === this.quadro[2][2]
    ) {
    ...
    if (
      this.quadro[0][2] !== "" &&
      this.quadro[0][2] === this.quadro[1][1] &&
      this.quadro[0][2] === this.quadro[2][0]
    ) {
  ...
  trocarJogador() {
    ...
    document.querySelector(
      "#info .jogador"
    ).textContent = `Vez do Jogador ${this.jogadorAtual}`;
  }
